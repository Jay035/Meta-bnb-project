...
export default function Footer() {
  return (
    <footer className="bg-[#1D1D1E] text-white grid gap-10 pt-14 pb-9 px-10 lg:px-28">
      <div className="grid gap-10 lg:gap-[11.7rem] md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        <section className="flex flex-col gap-8 pb-3 md:justify-between md:gap-24">
          {/* footer logo */}
          <img
        ...
        <section className="grid gap-10 md:gap-[13.56rem]">
