...
export default function Modal({ setModalState }) {
  return (
    <div className="flex justify-center items-center fixed inset-0 overflow-y-auto overflow-x-hidden bg-black/25 backdrop-blur-[1px]">
      <div className="relative w-[90%] my-6 mx-auto max-w-[600px]">
        ...
        <div className="border-0 rounded-2xl shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
          ...
          <section className="flex justify-between items-center py-4 px-6 md:py-6 md:px-8">
            <h3 className="text-xl md:text-2xl font-bold text-[#333333]">Connect Wallet</h3>
            <button className="">
              <i
          ...
          <section className="relative p-6 md:p-8 text-base flex flex-col gap-4 flex-none border-t border-[#CFD8DC]">
            <p className="leading-5 text-[#333333]">Choose your preferred wallet</p>
            {/* metamask */}
